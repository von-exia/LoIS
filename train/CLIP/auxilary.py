...
from rope import get_rotary_embeddings, apply_rotary_pos_emb
def multi_head_attention_forward(query: Tensor,
    ...
    if k is not None:
        ...
        # for RoPE
        # sin, cos = get_rotary_embeddings(head_dim, tgt_len, q.device)
        # q = q.reshape(bsz, num_heads, tgt_len, head_dim)# .transpose(1, 2)
        # k = k.reshape(bsz, num_heads, tgt_len, head_dim)# .transpose(1, 2)
