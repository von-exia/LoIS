...
class CLIP(nn.Module):
    ...
    def distill(self, y_s, y_t, T=1., alpha=0.0):
    ...
    def forward(self, image, text, teacher_sim=None):
        image_features = self.encode_image(image)
        text_features = self.encode_text(text)
        ...
        # loss_con = (
        #     self.distill(sim, teacher_sim.detach())
        #     + self.distill(sim.t(), teacher_sim.t().detach())
        # ) / 2
